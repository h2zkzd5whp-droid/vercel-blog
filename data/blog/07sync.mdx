...
- [1. 문제의식](#1-문제의식)
  - [1. spinlock만으로는 부족하다](#1-spinlock만으로는-부족하다)
  - [2. Interrupt disable/enable도 한계가 있다](#2-interrupt-disableenable도-한계가-있다)
  - [3. 그래서 뭐가 필요하나?](#3-그래서-뭐가-필요하나)
- [2. 고수준 동기화](#2-고수준-동기화)
- [3. Semaphores](#3-semaphores)
  - [1. Wait(S): 값을 감소](#1-waits-값을-감소)
  - [2. Signal(S): 값을 증가](#2-signals-값을-증가)
  - [3. 구현 예시](#3-구현-예시)
  - [4. binary semaphore 실행 흐름](#4-binary-semaphore-실행-흐름)
  - [5. 세마포어의 문제점](#5-세마포어의-문제점)
    - [1. deadlock](#1-deadlock)
    - [2. starvation](#2-starvation)
    - [3. Priority Inversion](#3-priority-inversion)
    - [4. 너무 자유도가 높아서 사용자가 실수하기 쉽다](#4-너무-자유도가-높아서-사용자가-실수하기-쉽다)
- [4. Classical Problems of Synchronization(동기화의 고질병)](#4-classical-problems-of-synchronization동기화의-고질병)
  - [1. Bounded-Buffer Problem](#1-bounded-buffer-problem)
  - [2. Dining-Philosophers Problem](#2-dining-philosophers-problem)
  - [3. Readers-Writers Problem](#3-readers-writers-problem)
- [5. Monitor](#5-monitor)
