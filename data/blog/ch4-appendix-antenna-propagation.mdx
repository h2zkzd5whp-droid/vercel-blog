...
- [9. Antenna & Propagation](#9-antenna--propagation안테나와-전파)
  - [9-1 안테나 기본](#9-1-안테나-기본)
  - [9-2 전자파의 특성](#9-2-전자파의-특성)
    - [1. 거리에 따른 감쇄](#1-거리에-따른-감쇄)
    - [2. 전파의 5가지 특성](#2-전파의-5가지-특성)
    - [3. Fading(페이딩)](#3-fading페이딩)
  - [9-3 안테나 성능 파라미터](#9-3-안테나-성능-파라미터)
    - [1. 방사 패턴(Radiation Pattern)](#1-방사-패턴radiation-pattern)
    - [2. 지향성과 이득](#2-지향성과-이득)
    - [3. 편파(Polarization)](#3-편파polarization)
