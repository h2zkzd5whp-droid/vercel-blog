...
- [Synchronization](#syncrhonization)
  - [스레드끼리 뭐가 공유되고 뭐가 공유 안되나](#스레드끼리-뭐가-공유되고-뭐가-공유-안되나)
  - [Critical Section](#critical-section)
  - [Critical Section의 요구사항](#critical-section의-요구사항)
    - [1. mutual exclusion](#1mutual-exclusion)
    - [2. 동기화에서의 progress](#2-동기화에서의-progress)
    - [3. bounded waiting](#3-bounded-waiting)
    - [4. performance](#4-performance)
  - [Critical Section의 요구사항을 만족시키기 위한 조건들](#critical-section의-요구사항을-만족시키기-위한-조건들)
  - [Locks](#locks)
  - [Locks의 문제점 해결법 3가지](#locks의-문제점-해결법-3가지)
    - [1. 알고리즘 사용](#1-알고리즘-사용)
    - [2. 하드웨어 지원](#2-하드웨어-지원)
    - [3. interrupts 꺼버리기](#3-interrupts-꺼버리기)
  - [초기 알고리즘](#초기-알고리즘acquire-문제점-해결을-위한)
