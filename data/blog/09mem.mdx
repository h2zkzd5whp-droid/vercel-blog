...
- [1. 메모리 관리의 목표](#1-메모리-관리의-목표)
- [2. Single / Batch Programming](#2-single--batch-programming)
- [3. Multiprogramming](#3-multiprogramming)
  - [virtual address vs physical address](#virtual-address-vs-physical-address)
- [4. 여러 프로세스를 메모리에 올리는 방법(구식)](#4-여러-프로세스를-메모리에-올리는-방법구식)
  - [1. Fixed Partitions](#1-fixed-partitions)
  - [2. Variable Partitions](#2-variable-partitions)
    - [Allocation strategies](#allocation-strategies)
  - [3. Overlays](#3-overlays)
  - [4. Swapping](#4-swapping)
- [5. Virtual Memory](#5-virtual-memory)
  - [1. 핵심 개념](#1-핵심-개념)
  - [2. 왜 필요한가?](#2-왜-필요한가)
  - [3. 주소 변환 흐름](#3-주소-변환-흐름)
